...
bool my_interfaces__msg__ldr_landmark_msg2_d__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_interfaces.msg._ldr_landmark_msg2_d.LdrLandmarkMsg2D", full_classname_dest, 55) == 0);
  }
  my_interfaces__msg__LdrLandmarkMsg2D * ros_message = _ros_message;
  {  // label
...
{
  /* NOTE(esteve): Call constructor of LdrLandmarkMsg2D */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_interfaces.msg._ldr_landmark_msg2_d");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LdrLandmarkMsg2D");
